...
// setup index file and store file
...
// Append a new record to the active segment
...
// LowestOffset return the lowest offset in all segments
...
// HighestOffset return the highest offset in all segments
...
// Truncate removes all segments whose highest offset is lower than the input number
